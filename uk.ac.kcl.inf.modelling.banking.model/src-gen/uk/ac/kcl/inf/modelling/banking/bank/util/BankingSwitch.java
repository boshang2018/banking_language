 ...
 * @generated
 */
public class BankingSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case BankingPackage.MANAGER: {
			...
			if (result == null)
				result = casePerson(manager);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BankingPackage.PERSON: {
		...
		case BankingPackage.CLIENT: {
			...
			if (result == null)
				result = casePerson(client);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BankingPackage.BANKING_PROGRAM: {
			BankingProgram bankingProgram = (BankingProgram) theEObject;
			T result = caseBankingProgram(bankingProgram);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case BankingPackage.WITHDRAWAL: {
			...
			if (result == null)
				result = caseTransactionStep(withdrawal);
			if (result == null)
				result = caseScriptStep(withdrawal);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BankingPackage.DEPOSIT: {
			...
			if (result == null)
				result = caseTransactionStep(deposit);
			if (result == null)
				result = caseScriptStep(deposit);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BankingPackage.TRANSACTION_STEP: {
			TransactionStep transactionStep = (TransactionStep) theEObject;
			T result = caseTransactionStep(transactionStep);
			if (result == null)
				result = caseScriptStep(transactionStep);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BankingPackage.CREATE_ACCOUNT: {
			CreateAccount createAccount = (CreateAccount) theEObject;
			T result = caseCreateAccount(createAccount);
			if (result == null)
				result = caseScriptStep(createAccount);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseBankingProgram(BankingProgram object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Transaction Step</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Transaction Step</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTransactionStep(TransactionStep object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Create Account</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Create Account</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCreateAccount(CreateAccount object) {
		return null;
	}
