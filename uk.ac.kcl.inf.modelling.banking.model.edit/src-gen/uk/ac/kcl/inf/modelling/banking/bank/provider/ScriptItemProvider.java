...
/**
 * This is the item provider adapter for a {@link uk.ac.kcl.inf.modelling.banking.bank.Script} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScriptItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addCurrentPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Script_current_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Script_current_feature",
								"_UI_Script_type"),
						BankingPackage.Literals.SCRIPT__CURRENT, true, false, true, null, null, null));
	}
	...
	protected void addStartPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Script_start_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Script_start_feature", "_UI_Script_type"),
						BankingPackage.Literals.SCRIPT__START, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BankingPackage.Literals.SCRIPT__STEPS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(BankingPackage.Literals.SCRIPT__STEPS, BankingFactory.eINSTANCE.createDeposit()));

		newChildDescriptors.add(createChildParameter(BankingPackage.Literals.SCRIPT__STEPS,
				BankingFactory.eINSTANCE.createCreateAccount()));
	}
