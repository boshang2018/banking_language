...
/**
 * This is the item provider adapter for a {@link uk.ac.kcl.inf.modelling.banking.bank.Manager} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ManagerItemProvider extends PersonItemProvider {
	/**
	...
	protected void addClientsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Manager_clients_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Manager_clients_feature",
								"_UI_Manager_type"),
						BankingPackage.Literals.MANAGER__CLIENTS, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Manager_type")
